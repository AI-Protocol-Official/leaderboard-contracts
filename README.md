# AI Protocol Leaderboard Contracts #
Leaderboard reward system designated to release reward for all leaderboard winners.
...
* Smart Contract(s):
    * [RewardSystem](contracts/bonding_curves/RewardSystem.sol) – RewardSystem leaderboard implementation
